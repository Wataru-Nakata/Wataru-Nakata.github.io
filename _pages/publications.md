...
{% endfor %}
# preprints
1. Asai, K., **Nakata, W.**, Saito, Y., & Saruwatari, H. (2026). Geneses: Unified Generative Speech Enhancement and Separation. arXiv preprint arXiv:2601.18456.
1. Yang, J., **Nakata, W.**, Saito, Y., & Saruwatari, H. (2026). DistilMOS: Layer-Wise Self-Distillation For Self-Supervised Learning Model-Based MOS Prediction. arXiv preprint arXiv:2601.13700.
1. **Nakata, W.**, Saito, Y., Ueda, Y., & Saruwatari, H. (2025). Sidon: Fast and robust open-source multilingual speech restoration for large-scale dataset cleansing. arXiv preprint arXiv:2509.17052.
1. Nishikawa, G., **Nakata, W.**, Saito, Y., Imamura, K., Saruwatari, H., & Nakamura, T. (2025). Multi-Sampling-Frequency Naturalness MOS Prediction Using Self-Supervised Learning Model with Sampling-Frequency-Independent Layer. arXiv preprint arXiv:2507.14647.
1. **Nakata, W.**, Seki, K., Yanaka, H., Saito, Y., Takamichi, S., & Saruwatari, H. (2024). J-CHAT: Japanese large-scale spoken dialogue corpus for spoken dialogue language modeling. arXiv preprint arXiv:2407.15828.
...
# Journal
1. Yang, D., Saito, Y., Saeki, T., Koriyama, T., **Nakata, W.**, Xin, D., & Saruwatari, H. (2025). Speaker-conditioned phrase break prediction for text-to-speech with phoneme-level pre-trained language model. *Speech Communication*.
...
1. **W. Nakata**, Y. Koizumi, S. Karita, R. Scheibler, H. Ishikawa, A. Guevara-Rukoz, H. Zen, and M. Bacchiani, "ReverbMiipher: Generative Speech Restoration meets Reverberation Characteristics Controllability," 2025 IEEE Workshop on Applications of Signal Processing to Audio and Acoustics (WASPAA), 2025, pp. 1-5.
